...
build: .FORCE
	...
	docker build --platform linux/amd64 --no-cache -t fastai/fastpages-jekyll -f _action_files/fastpages-jekyll.Dockerfile .
	docker-compose build --force-rm --no-cache

# rebuild the services WITH cache
quick-build: .FORCE
	docker-compose stop || true;
	docker build --platform linux/amd64 -t fastai/fastpages-jekyll -f _action_files/fastpages-jekyll.Dockerfile .
